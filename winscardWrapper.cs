/******************************************************************************
 * 
 * Wrapper for winscard
 * 
 * Code is rip off from http://pastie.org/1527598
 * 
 *****************************************************************************/
...
namespace CardTalk
{
    public class winscardWrapper
    {
        ...
        // TODO: refer to http://pyscard.sourceforge.net/epydoc/smartcard.scard.scard-module.html
        ...
        [DllImport("winscard.dll")]
        public static extern int SCardGetAttrib(int hCard, int attribId, ref byte attrib, ref uint attribLen);

        [DllImport("winscard.dll")]
        public static extern int SCardFreeMemory(int hCard, ref int pvMem);
